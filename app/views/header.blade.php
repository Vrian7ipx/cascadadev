  ...
  <div class="container">
    ...
    <div class="navbar-header">
      ...
      <a href="{{ URL::to('/') }}" class='navbar-brand'>
        <img src="{{ asset('images/logo-factura-virtual.png') }}" style="height:30px;margin-top:-5px;width:auto"/>
      </a>	    
    </div>
      ...
      <div class="navbar-form navbar-right">
        ...
        <div class="btn-group">
          ...
          @if (Utils::isAdmin())
            ...
            <li>{{ link_to('company/branches', uctrans('texts.branch_details')) }}</li>
            <li>{{ link_to('company/user_management', uctrans('texts.user_management')) }}</li>
            <li>{{ link_to('company/groups', uctrans('texts.group_details')) }}</li>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div style="background-color: #fff; padding-right:20px" id="signUpDiv" onkeyup="validateSignUp()" onclick="validateSignUp()" onkeydown="checkForEnter(event)">
        ...
        {{ Former::checkbox('terms_checkbox')->label(' ')->text(trans('texts.agree_to_terms', ['terms' => '<a href="" target="">'.trans('texts.terms_of_service').'</a>'])) }}
        {{ Former::close() }}
      ...
      <div class="modal-footer" id="signUpFooter" style="margin-top: 0px">	      	
        ...
        <button type="button" class="btn btn-primary" id="saveSignUpButton" onclick="validateServerSignUp()">{{ trans('texts.save') }} <i class="glyphicon glyphicon-floppy-disk"></i></button>
      </div>
    </div>
  </div>
</div>
...
<div class="container">{{ trans('texts.powered_by') }} <a href="https://www.ipxserver.com/" target="_blank">iPX Server</a></div>
@endif
      ...
      if (!window.hasOwnProperty('searchData')) {
        $.get('{{ URL::route('getSearchData') }}', function(data) {  						
          ...
          $('#search').typeahead(datasets).on('typeahead:selected', function(element, datum, name) {
            ...
            window.location = '{{ URL::to('/') }}' + '/' + type + '/' + datum.public_id + '/edit' ;
